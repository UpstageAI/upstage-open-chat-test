...
async def update_rag_config(
    ...
    if form_data.web is not None:
        ...
        request.app.state.config.WEB_SEARCH_ENGINE = form_data.web.WEB_SEARCH_ENGINE   #TODO: 기존 코드는 RAG_WEB_SEARCH_ENGINE 이었음. 마지막에 ".lower()" 추가되어 있었음. 모두 소문자로 하려고 한듯.
    ...
    try:
        ...
        if form_data.content:
            ...
            if file_path:
                ...
                # TODO: Check why this code block is commented out
                # loader = Loader(
